...
void drawObjects(TObject** objects, TString root_file_name, TString name, TString title="Direxeno by channel", TString timestring="hh:mm:ss", int logy=0, int fits=0, int logz=0,int PMTNum=27);
void draw2Objects(TObject** objects1,   TObject** objects2,TString root_file_name, TString name, TString title="Direxeno by channel",TString timestring="hh:mm:ss",int logy=0, int fits=0, int logz=0, int PMTNum=27);
